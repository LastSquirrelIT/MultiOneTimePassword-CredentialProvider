...
class CMultiOneTimePasswordCredentialProviderFilter : public ICredentialProviderFilter 
{ 
	public: 
	...
	protected: 
	CMultiOneTimePasswordCredentialProviderFilter(); 
	__override ~CMultiOneTimePasswordCredentialProviderFilter(); 
